...
module ultrasonic_beep2_test;
  ...
  initial begin
    ...
    #(25 * NS_PER_CM);
    echo_bwd2 = 0;
    #20000000;  // Observe 20ms of silence
    ...
    #(15 * NS_PER_CM);
    echo_bwd2 = 0;
    #40000000;  // Observe 40ms of pulsing
    ...
    #(5 * NS_PER_CM);
    echo_bwd2 = 0;
    #40000000;  // Observe 40ms of constant high
